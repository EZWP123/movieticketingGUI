 ...
 */
public class User_AddRecovery extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Main.add(Header, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 100));
        ...
        Navigation.add(acc_type, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 300, 30));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(Main, javax.swing.GroupLayout.PREFERRED_SIZE, 950, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
//            dbc.updateData("UPDATE tbl_accounts SET security_question = '" + secQuestion + "', security_answer='" + secAnswer + "' WHERE u_id = '" + sess.getUid() + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_AddRecovery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new User_AddRecovery().setVisible(true);
            }
        });
    }
